"""
PaymentGateway API - Backend API
...
app = FastAPI(
    ...
    description="Unified payment processing API supporting multiple providers",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "PaymentGateway API"}
